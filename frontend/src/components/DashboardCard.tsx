...
const DashboardCard = ({icon, title, body}: Props) => {
  return (
    <Link
      to={`/dashboard`}
      className={`flex flex-col cursor-pointer hover:shadow-lg hover:shadow-orange-400 items-center rounded-md bg-sky-950 hover:bg-[url('https://res.cloudinary.com/dd0tbhnzl/image/upload/v1709083583/typeSelected.gif')] hover:bg-no-repeat hover:bg-center hover:bg-cover group`}
    >
