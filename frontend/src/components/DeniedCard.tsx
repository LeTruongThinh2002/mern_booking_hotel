...
const DeniedCard = ({card}: Props) => {
  return (
    <div className='flex hover:scale-125 flex-row gap-4 rounded-lg bg-sky-950 shadow-lg shadow-red-600'>
      <img
        src={card.image}
        alt=''
      ...
      <div className='basis-3/4 flex flex-col gap-1'>
        ...
        <span className='text-lg text-red-400'>
          Key:{' '}
          <span className='line-through text-red-400 opacity-50'>
            {card.key}
          </span>
        </span>
      </div>
